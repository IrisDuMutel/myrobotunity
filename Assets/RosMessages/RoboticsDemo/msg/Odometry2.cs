...
{
    public class Odometry2 : Message
    {
        public const string RosMessageName = "robotics_demo/Odometry2";
        ...
        public Odometry2(string name, float pos_x, float pos_y, float pos_z, float orient_1, float orient_2, float orient_3, float vel_x, float vel_y, float vel_z, float ang_x, float ang_y, float ang_z)
        {
            this.name = name;
            this.pos_x = pos_x;
            this.pos_y = pos_y;
